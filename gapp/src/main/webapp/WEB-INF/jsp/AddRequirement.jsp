	...
	<div style="margin-top: 60px">
		<div class="col-md-4" style="margin-left: 350px">
			<div class="panel panel-warning">
				...
				<div class="panel-body">
					<form:form class="form-horizontal" role="form" modelAttribute="req">


						<div class="form-group">
							<label class="col-sm-3 control-label">Name</label>
							<div class="col-sm-9">
								<form:input class="form-control" path="rec_name"
									required="required" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<form:select path="rec_type" class="form-control">
									<form:option value="NONE" label="--- Select ---" />
									<form:option value="Integer" item="Integer" />
									<form:option value="String" item="String" />
									<form:option value="File" item="File" />
								</form:select>
							</div>
						</div>
						<div class="row">
							<div class="col-sm-3">Requirements</div>
							<div class="col-sm-9">
								<div class="inline">
									<form:radiobutton class="radio" path="required" value="true"
										label="Required" />
								</div>
								<div class="inline">
									<form:radiobutton class="radio" path="required" value="false"
										label="Optional" />
